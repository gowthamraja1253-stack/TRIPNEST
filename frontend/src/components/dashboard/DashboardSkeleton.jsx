  ...
  return (
    <div className="space-y-8 pb-8 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-surface rounded-[20px] border border-border/50 p-6 h-[140px] flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
            <Skeleton className="bg-surface border border-border/50" height="h-[400px]" rounded="rounded-[20px]" />
            <Skeleton className="bg-surface border border-border/50" height="h-[400px]" rounded="rounded-[20px]" />
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <Skeleton className="bg-surface border border-border/50" height="h-[400px]" rounded="rounded-[20px]" />
          <Skeleton className="bg-surface border border-border/50" height="h-[300px]" rounded="rounded-[20px]" />
        </div>
      </div>
    </div>
  );
